...
import YaerBall from "../../svg/ball.jsx"
import YaerBall2 from "../../svg/ball2.jsx"
import YaerBall3 from "../../svg/ball3.jsx"
import YaerBall4 from "../../svg/ball4.jsx"
import rand from "../../service/index.js"
...
class InteractionServer extends Component {
  render() {
    ...
    for (let i = 0; i < 48; i++) {
      ...
      {
        if(rand(2) % 2 !== 0)
          balls[i] = (<li className="yaerBall"><YaerBall /></li>)
        else
          balls[i] = (<li className="yaerBall"><YaerBall2 /></li>)
      }
      else
      {
        if(rand(2) % 2 !== 0)
          balls[i] = (<li className="yaerBall"><YaerBall3 /></li>)
        else
          balls[i] = (<li className="yaerBall"><YaerBall4 /></li>)
      }
    }
    return (
      <section className="controlServer">
        <ul className="FirstBalls">
          {balls}
        </ul>
        <ul
